...
// SSD1306 (I²C) - UFC Comm1 Display (SCL: A5, SDA: A4, RESET optional: 4)
U8X8_SSD1306_128X64_NONAME_HW_I2C oledComm1(U8X8_PIN_NONE);

// SSD1306 (I²C) - UFC Comm2 Display (SCL: A5, SDA: A4, RESET optional: 4)
...
void onUfcScratchpadChange(char* newValue) {
    if (strcmp(ufcScratchpadText, newValue) != 0) {
        ...
        ufcScratchpadText[12] = '\0';  // Korrektur des Fehlers
